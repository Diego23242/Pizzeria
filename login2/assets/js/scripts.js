...
$(document).ready(function() {
    ...
    // Agregar producto al hacer clic en algún botón "Agregar al carrito"
    $('.btnAgregarCarrito').click(function() {
        let producto_id = $(this).data('id');

        // Obtener el arreglo de productos del almacenamiento local
        let productos = localStorage.getItem('productos');

        // Si no hay productos en el carrito, crear un nuevo arreglo
        if (productos === null) {
            productos = [];
        } else {
            // Si hay productos en el carrito, convertir la cadena JSON a un arreglo
